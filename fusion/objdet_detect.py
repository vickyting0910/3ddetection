...
def load_configs_model(model_name='darknet', configs=None):
    ...
    if model_name == "darknet":
        configs.model_path = os.path.join(parent_path, 'tool', 'objdet_models', 'darknet')
        ...
        configs.model_path = os.path.join(parent_path, 'tool', 'objdet_models', 'resnet')
...
def detect_objects(input_bev_maps, model, configs):
    ...
    for obj in detections:
        scores, _x, _y, z, h, _w, _l, yaw = obj
        ...
        if ((x >= configs.lim_x[0]) and (x <= configs.lim_x[1])
            ...
            ## step 4 : append the current object to the 'objects' array
            objects.append([scores, x, y, z, h, w, l, yaw])
