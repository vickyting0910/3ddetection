...
def show_pcl(lidar_pcl):
    ...
    vis_calls.create_window(window_name='Open3D', width=800, height=600, left=50, top=50, visible=True)
...
def show_range_image(frame, lidar_name):
    ...
    # step7: Crop range image to +/- 90 deg. left and right of the forward-facing x-axis, focus on +/- 90° around the image center
